...
its simple name is either *NotNull* or *NonNull* (this of course includes _org.jetbrains.annotations.NotNull_,
...
p. A similar exception will be raised when a method carrying a *@NotNull* / *@NonNull* annotation returns a _null_ value.
